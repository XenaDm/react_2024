...
useRef - як і useState, спроможний запам'ятовуваати стани якщо сторінка переренджується, але на відміну від useState цей хук не повинен приймати участі у рендерінгу(його значення не повинно відображатися в розмітці UI).
